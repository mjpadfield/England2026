...
import { planBRoute, planBStops } from "@/lib/data";
...
export default function PlanBMapInner() {
  return (
    ...
    >
      ...
      <Polyline positions={planBRoute} pathOptions={{ color: "#3b82f6", weight: 2, opacity: 0.8, dashArray: "6 8" }} />
      {planBStops.map((stop) => (
        <CircleMarker key={stop.name} center={stop.coords} radius={8}
      ...
      <style>{`
        .journey-tooltip { background: rgba(10,10,20,0.9) !important; border: 1px solid rgba(255,255,255,0.15) !important; border-radius: 8px !important; padding: 6px 10px !important; white-space: nowrap; }
